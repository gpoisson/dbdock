...
# records in the unsorted ligand data are structured as numpy arrays with the following indeces:
name_index = 0
mol_index = 1
ki_index = 2
...
def main():
	...
	# iterate <batches> many times, take an x_train, x_test, y_train, y_test set.
	#     train on x_train and y_train, test on x_test and y_test
	...
	# after <batches> many models, compute the mean prediction error for each validation sample
	pred = []
	mean_pred = []
